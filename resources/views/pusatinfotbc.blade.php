                    ...
                    <div class="row g-3 mb-4 small text-secondary">
                        <div class="col-md-6">
                            <div class="p-4 rounded-4 bg-teal bg-opacity-10 h-100">
                                ...
                                <p class="mb-0">Pasien wajib minum obat setiap hari untuk membunuh bakteri aktif dengan cepat dan mengurangi risiko penularan.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-4 rounded-4 bg-teal bg-opacity-10 h-100">
                                <h6 class="fw-bold text-teal mb-2">2. Tahap Lanjutan (4 Bulan Berikutnya)</h6>
                                <p class="mb-0">Pasien meminum obat secara berkala (sesuai anjuran dokter) untuk membersihkan sisa bakteri tidur dan mencegah kekambuhan.</p>
                            </div>
                        </div>
                    </div>

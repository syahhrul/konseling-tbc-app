        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-9">
                ...
                <div class="card info-card p-4 p-md-5" id="deskripsi">
                    ...
                    <p class="lead text-secondary fs-6 mb-3">Tuberkulosis (TBC) adalah penyakit menular yang disebabkan oleh infeksi kuman/bakteri <strong>Mycobacterium tuberculosis</strong>. Meskipun bakteri ini paling sering menyerang organ paru-paru (TBC Paru), TBC juga dapat menyebar ke organ tubuh lainnya seperti kelenjar getah bening, tulang, ginjal, selaput otak, maupun kulit (TBC Ekstra Paru).</p>
                ...
                <div class="card info-card p-4 p-md-5" id="penularan">
                    ...
                    <ul class="list-group list-group-flush mb-4 small text-secondary">
                        ...
                        <li class="list-group-item bg-transparent px-0"><i class="fa-solid fa-circle-chevron-right text-teal me-2"></i>Orang di sekitar menghirup udara yang terkontaminasi oleh kuman tersebut.</li>
                        <li class="list-group-item bg-transparent px-0"><i class="fa-solid fa-circle-chevron-right text-teal me-2"></i>Kuman masuk melalui saluran pernapasan menuju paru-paru dan dapat menyebar ke bagian tubuh lainnya.</li>
                    </ul>
                ...
                <div class="card info-card p-4 p-md-5" id="pengobatan">
                    ...
                    <div class="alert alert-danger border-0 rounded-3 mb-0 small">
                        ...
                        Jika pengobatan dihentikan sebelum 6 bulan (meskipun tubuh sudah terasa sehat), kuman TBC yang tersisa akan bermutasi menjadi kebal terhadap obat standar. Kondisi ini disebut <strong>TBC Resisten Obat (MDR-TB)</strong>, yang membutuhkan waktu pengobatan jauh lebih lama (9 - 24 bulan) dengan efek samping obat yang lebih berat.
                    </div>
                </div>
